...
<html>
    <head>
        ...
        <style>
            ...
            */#search {
                position: absolute; top: 0; right: 0; margin: 1%;
            }
            #player{
                margin-left: 10%; margin-right: 10%; width: 80%
            }
            #empfehlungen { 
                border: 3px solid green; width: 80%; margin-left: 10%;
            }
            #informationen { 
                border: 3px solid orange; width: 80%; margin-left: 10%; /*margin-bottom: 10%*/
            }
            .abschnitt { 
                float: left; width: 50%; background-color: pink; overflow: scroll;
            }
            .zwei  { 
                width: 50%; background-color: darkblue; height: 30%; overflow: hidden;
            }
            .clear { 
                clear: both; 
            }
